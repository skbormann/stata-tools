...
cscript "fdrisk-test until version 1.1a" adofiles fdrisk 

**Testing the old syntax -> Deactivated for version 1.1a; prior to that the old syntax did not work as intended anymore since version 1.1
*First example
/*
