...
program ttest_sim
	...
	Xeq sgpvalue, estlo(`ci1') esthi(`ci2') nulllo(-1) nullhi(1) 
	restore
...
program dichdata_sim
	...
	* On the difference in proportions
	...
	Xeq sgpvalue, estlo(`ci1') esthi(`ci2') nulllo(-0.2) nullhi(0.2)
	...
	*On the log odds ratio scale
	...
	Xeq sgpvalue, estlo(`cior1') esthi(`cior2') nulllo(`=log(1/1.5)') nullhi(`=log(1.5)')
	restore
end
*Taking from gr_example2.ado
program Xeq
        di as txt
